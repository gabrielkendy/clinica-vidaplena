# 📝 DESCRIÇÃO — AULA 03 · "A chave na vitrine e o banco no chão" (o fecho)
...
📌 CAPÍTULOS
0:00 O final da série (e a vitrine do sistema)
[…] Falha 7: a chave escrita no site (Ctrl + U, busca "key")
...
🏷️ TAGS
vibe coding, segurança, segurança de aplicações, programação com IA, cursor, vibe coding segurança, backup exposto, segredo no front, headers de segurança, dev com ia, inteligência artificial programação, blindagem de sistemas, owasp top 10, vibe coding brasil, fecho de série
...
## 🧩 Notas de publicação
- Parte 3 (final) — selo/playlist "Segurança com IA"
- Thumb: `03-THUMBNAIL/` (TAG "PARTE FINAL" · headline "A CHAVE / DO SISTEMA")
- No fim do vídeo: card do vídeo 1 (a série começa ali) + fixar o comentário
